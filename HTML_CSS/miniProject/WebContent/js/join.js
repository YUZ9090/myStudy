...
const passwordcheck = document.getElementById("passwordcheck");
	...
	function input(){
		...
		if(password.value.trim()!=passwordcheck.value.trim()){
			document.getElementById("pwckDiv").innerText="비밀번호가 같지 않습니다";
			passwordcheck.focus();
	...
	function OnChange(){      
		var select = document.getElementById("email4").options[document.getElementById("email4").selectedIndex].value;
		var mail = "";
		
		if ( select == "naver" ){
			mail = "naver.com";
			document.getElementById("email3").readOnly=true;
		}else if( select == "hanmail"){
			mail = "hanmail.com"
			document.getElementById("email3").readOnly=true;
		}else if( select=="gmail"){
			mail = "gmail.com";
			document.getElementById("email3").readOnly=true;
		}else if(select =="none"){
			mail = "";
		...
		document.getElementById("email3").value=mail;
